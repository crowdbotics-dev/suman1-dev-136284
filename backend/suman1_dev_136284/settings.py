"""
Django settings for suman1_dev_136284 project.
...
ROOT_URLCONF = 'suman1_dev_136284.urls'
...
WSGI_APPLICATION = 'suman1_dev_136284.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "suman1 Support <support@suman1-dev-136284.botics.co>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "suman1_dev_136284 API",
    "DESCRIPTION": "API documentation for suman1_dev_136284 App",
    "VERSION": "v1",
}
